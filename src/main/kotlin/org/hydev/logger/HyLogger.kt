...
class HyLogger(val prefix: String)
{
    ...
    fun info(message: Any) = log(LOG, message.toString())
    ...
    fun info(format: String, vararg args: Any) = log(LOG, format, *args)
    ...
    fun infof(format: String, vararg args: Any) = logf(LOG, format, *args)
